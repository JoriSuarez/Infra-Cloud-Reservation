...
Le paramètre 'PostUp' sera exécuté chaque fois que le serveur Wirguard démarrera le tunnel VPN. Le paramètre 'PostDown' sera exécuté chaque fois que le serveur Wireguard arrêtera le tunnel VPN.
